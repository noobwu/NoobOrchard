...
namespace Noob.Web.Admin.EasyUI.OrmLite.MySql
{
    ...
    public class NoobAdminOrmLiteDataModule : Autofac.Module
    {
        ...
        private void RegisterOrmLite(ContainerBuilder builder)
        {
            ...
            var connectionString = @"Server=127.0.0.1;Port=3308;Database=noob; User=root;Password=root;Use Procedure Bodies=false;Charset=utf8;Allow Zero Datetime=True; Pooling=True; Max Pool Size=50;";
