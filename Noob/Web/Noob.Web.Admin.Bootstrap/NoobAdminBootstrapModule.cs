...
namespace Noob.Web.Admin.Bootstrap
{
    ...
    /// 
    /// </summary>
    public class NoobAdminBootstrapModule : Autofac.Module
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            //controllers
            //var controllerAssembly = Assembly.GetAssembly(typeof(Noob.Web.Admin.Bootstrap.Controllers.BaseAdminController));
