...
namespace OrchardNorthwind.Services.OrmLite
{
    ...
    /// </summary>
    public partial class EmployeeTerritoryService:OrchardNorthwind.Services.EmployeeTerritoryService
    {
        /// <summary>
        /// 
        /// </summary>
        private OrmLiteRepositoryBase<EmployeeTerritory, string> _repository;
        ...
        public EmployeeTerritoryService(OrmLiteRepositoryBase<EmployeeTerritory, string> repository) : base(repository)
        {
