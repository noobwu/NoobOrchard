    ...
    public abstract class QueueTestBase : TestWithLoggingBase, IDisposable
    {
        ...
        public virtual async Task CanAbandonQueueEntryOnceAsync()
        {
            ...
            try
            {
                ...
                Assert.ThrowsAsync<InvalidOperationException>(async() =>await workItem.AbandonAsync());
                Assert.ThrowsAsync<InvalidOperationException>(async() => await workItem.CompleteAsync());
                Assert.ThrowsAsync<InvalidOperationException>(async() => await workItem.CompleteAsync());
                ...
                Assert.ThrowsAsync<InvalidOperationException>(async () => await workItem.CompleteAsync());
                Assert.ThrowsAsync<InvalidOperationException>(async () => await workItem.AbandonAsync());
                Assert.ThrowsAsync<InvalidOperationException>(async () => await queue.AbandonAsync(workItem));
                Assert.ThrowsAsync<InvalidOperationException>(async () => await queue.CompleteAsync(workItem));
            }
            finally
            {
                await CleanupQueueAsync(queue);
