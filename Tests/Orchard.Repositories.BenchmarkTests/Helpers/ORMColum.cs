...
namespace Orchard.Repositories.BenchmarkTests
{
    ...
    public class ORMColum : IColumn
    {
        ...
        /// <returns></returns>
        public string GetValue(Summary summary, Benchmark benchmark) => benchmark.Target.Method.DeclaringType.Namespace.Replace("Orchard.Repositories.BenchmarkTests.", string.Empty);
        /// <summary>
        ...
        /// <returns></returns>
        public string GetValue(Summary summary, Benchmark benchmark, ISummaryStyle style) => benchmark.Target.Method.DeclaringType.Namespace.Replace("Orchard.Repositories.BenchmarkTests.", string.Empty);
        /// <summary>
        /// 
        /// </summary>
        /// <param name="summary"></param>
