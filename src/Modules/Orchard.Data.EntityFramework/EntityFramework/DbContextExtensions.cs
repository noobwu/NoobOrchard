...
namespace Orchard.Data.EntityFramework
{
    public static class DbContextExtensions
    {
        ...
        private static T InnerGetCopy<T>(EfDbContext context, T currentCopy, Func<DbEntityEntry<T>, DbPropertyValues> func) where T : Domain.Entities.Entity
        {
        ...
        /// <returns></returns>
        private static DbEntityEntry<T> GetEntityOrReturnNull<T>(T currentCopy, DbContext dbContext) where T : Domain.Entities.Entity
        {
            return dbContext.ChangeTracker.Entries<T>().FirstOrDefault(e => e.Entity == currentCopy);
        }

        private static DbContext CastOrThrow(EfDbContext context)
        {
        ...
        /// <param name="currentCopy">The current copy.</param>
        /// <returns></returns>
        public static T LoadOriginalCopy<T>(this EfDbContext context, T currentCopy) where T : Domain.Entities.Entity
        {
        ...
        /// <param name="currentCopy">The current copy.</param>
        /// <returns></returns>
        public static T LoadDatabaseCopy<T>(this EfDbContext context, T currentCopy) where T : Domain.Entities.Entity
        {
        ...
        public static string GetTableName<T>(this EfDbContext context) where T : Domain.Entities.Entity
        {
        ...
        public static int? GetColumnMaxLength(this EfDbContext context, string entityTypeName, string columnName)
        {
        ...
        /// <returns></returns>
        public static IDictionary<string, int> GetColumnsMaxLength(this EfDbContext context, string entityTypeName, params string[] columnNames)
        {
            int temp;
        ...
        /// <param name="columnNames">Column names</param>
        /// <returns></returns>
        public static IDictionary<string, decimal> GetDecimalMaxValue(this EfDbContext context, string entityTypeName, params string[] columnNames)
        {
        ...
        private static Dictionary<string, ReadOnlyMetadataCollection<Facet>> GetFildFacets(this EfDbContext context,
        ...
        public static string DbName(this EfDbContext context)
        {
