...
namespace Orchard.Web.Mvc.Filters
{
    ...
    {
        private WebConfig _webConfig = null;
        private ILoggerFactory loggerFactory = null;
        public WebApiPerformanceAttribute(WebConfig webConfig,ILoggerFactory logFactory = null)
        {
            //webConfig = ContainerContext.Current.Resolve<WebConfig>();
        ...
        public override void OnActionExecuting(HttpActionContext actionContext)
        {
            ...
            if (_webConfig.PerformanceEnabled == false)
            {
                return;
            }
            ...
            PerformanceTracker tracker = new PerformanceTracker(info,loggerFactory);
        ...
        private ActionInfo CreateActionInfo(HttpActionContext actionContext)
        {
            ...
            int processId = _webConfig.ProcessId;
