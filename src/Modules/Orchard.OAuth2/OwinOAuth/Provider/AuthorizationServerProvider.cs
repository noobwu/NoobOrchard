...
namespace Orchard.OAuth2.OwinOAuth.Provider
{
    ...
    public class AuthorizationServerProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override async Task AuthorizeEndpoint(OAuthAuthorizeEndpointContext context)
        {
            ...
            {
                logger.Debug("AuthorizeEndpoint,ImplicitGrant,clientId:" + clientId + ",clientSecret:" + clientSecret + ",redirectUri:" + redirectUri);
                //implicit 授权方式
                HandleImplicitGrant(context,client,redirectUri);
            }
            else if (context.AuthorizeRequest.IsAuthorizationCodeGrantType)
            {
                logger.Debug("AuthorizeEndpoint,AuthorizationCodeGrant,clientId:" + clientId+ ",clientSecret:"+clientSecret+ ",redirectUri:"+ redirectUri);
        ...
        {
            logger.Debug("ValidateAuthorizeRequest,context.AuthorizeRequest.ClientId:"+ context.AuthorizeRequest.ClientId);
