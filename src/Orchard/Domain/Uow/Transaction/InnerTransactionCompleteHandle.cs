...
namespace Orchard.Domain.Uow
{
    ...
    /// </summary>
    public class InnerTransactionCompleteHandle : ITransactionCompleteHandle
    {
        public IDbConnection _connection;
        private IDbTransaction _transaction;
        public ILogger Logger { get; set; }
        public InnerTransactionCompleteHandle(IDbConnection connection, IsolationLevel isolationLevel)
        {
