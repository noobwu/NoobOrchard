...
namespace Orchard.Utility
{
    internal static class CloneExpressionHelper {
        ...
        static readonly MethodInfo _fieldInfoSetValueMethod = typeof(FieldInfo).GetMethod("SetValue", new[] { ObjectType, ObjectType });
        ...
        static readonly MethodInfo _getTypeMethodInfo = ObjectType.GetMethod("GetType");
        ...
        internal static Expression CreateSetFieldExpression(Expression clone, Expression value, FieldInfo fieldInfo) {
            ...
            if (fieldInfo.IsInitOnly)
                return Expression.Call(Expression.Constant(fieldInfo), _fieldInfoSetValueMethod, clone, Expression.Convert(value, ObjectType));
