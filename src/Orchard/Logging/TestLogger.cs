...
namespace Orchard.Logging
{
    ...
    public class TestLogger : ILogger {
        ...
        private static void LogFormat(Levels level, string message, params object[] args) {
        ...
        /// <param name="message">The message.</param>
        /// <param name="args">The args.</param>
        private static void LogFormat(Exception exception, Levels level, string message, params object[] args)
        {
            string msg = message?? string.Empty;
        ...
        {
            LogFormat(exception, Levels.DEBUG, format, args);
        }
        ...
        {
            LogFormat(exception,Levels.ERROR, format, args);
        }
        ...
        {
            LogFormat(exception, Levels.FATAL, format, args);
        }
        ...
        {
            LogFormat(exception,Levels.INFO, format, args);
        }
        ...
        {
            LogFormat(exception, Levels.WARN, format, args);
        }
