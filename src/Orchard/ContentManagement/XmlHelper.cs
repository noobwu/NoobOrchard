...
namespace Orchard.ContentManagement
{
    public static class XmlHelper
    {
            ...
            Expression<Func<TTarget, TProperty>> targetExpression)
        {
            ...
            var propertyInfo = GenericReflectionHelper<TTarget>.GetPropertyInfo(targetExpression);
        ...
        public class XElementWithContext<TContext>
        {
            ...
            {
                var propertyInfo = GenericReflectionHelper<TContext>.GetPropertyInfo(expression);
                var name = propertyInfo.Name;
