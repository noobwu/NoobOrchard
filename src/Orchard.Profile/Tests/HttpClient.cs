...
namespace Orchard.Profile.Tests {
    ...
    public class HttpClient {
        ...
        public void GivenIAmLoggedIn() {
            ...
            DoRequest("/Account/Login", "UserName=admin&Password=admin123@!@#&" + requestVerificationTokenName + "=" + requestVerificationTokenValue);
        }
        ...
        private void DoRequest(string url, string postData) {
            _request = (HttpWebRequest)WebRequest.Create("http://localhost:10063" + url);
